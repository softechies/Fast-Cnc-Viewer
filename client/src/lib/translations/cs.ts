...
const translations = {
  ...
  public_library_added: "Model přidán do veřejné knihovny",
  public_library_removed: "Model odebrán z veřejné knihovny",
  public_library_added_message: "Model byl úspěšně přidán do veřejné CAD knihovny",
  public_library_removed_message: "Model byl úspěšně odebrán z veřejné CAD knihovny",
  public_cad_library: "Veřejná CAD knihovna",
  public_library_description: "Procházejte a stahujte CAD modely sdílené naší komunitou. Všechny modely jsou zdarma pro použití ve vašich projektech.",
  search_models_tags: "Hledat modely a štítky...",
  all_categories: "Všechny kategorie",
  showing_models: "Zobrazeno {count} z {total} modelů",
  no_models_found: "Nenalezeny žádné modely",
  try_different_search: "Zkuste jiný vyhledávací výraz nebo vymažte filtry",
  no_public_models_yet: "Zatím nejsou k dispozici žádné veřejné modely",
  failed_to_load_library: "Nepodařilo se načíst knihovnu. Zkuste to později.",
  ...
  password_update_error: "Chyba při aktualizaci hesla",
  model_is_password_protected: "Tento model je chráněn heslem",
  open_in_browser: "Otevřít v prohlížeči",
  model_deleted: "Model smazán",
  model_delete_success: "Model byl úspěšně smazán",
  model_delete_error: "Chyba při mazání modelu",
  ...
  fileNotSupported: "Formát souboru není podporován",
