...
const translations = {
  ...
  public_library_added: "Modèle ajouté à la bibliothèque publique",
  public_library_removed: "Modèle retiré de la bibliothèque publique",
  public_library_added_message: "Le modèle a été ajouté avec succès à la bibliothèque CAO publique",
  public_library_removed_message: "Le modèle a été retiré avec succès de la bibliothèque CAO publique",
  public_cad_library: "Bibliothèque CAO publique",
  public_library_description: "Parcourez et téléchargez des modèles CAO partagés par notre communauté. Tous les modèles sont gratuits pour vos projets.",
  search_models_tags: "Rechercher modèles et étiquettes...",
  all_categories: "Toutes les catégories",
  showing_models: "Affichage de {count} sur {total} modèles",
  no_models_found: "Aucun modèle trouvé",
  try_different_search: "Essayez un autre terme de recherche ou effacez les filtres",
  no_public_models_yet: "Aucun modèle public disponible pour le moment",
  failed_to_load_library: "Échec du chargement de la bibliothèque. Veuillez réessayer plus tard.",
  cad_library_dimensions: "Dimensions",
  cad_library_view: "Voir",
  cad_library_download: "Télécharger",
  password_protected_public_error: "Impossible d'ajouter un modèle protégé par mot de passe à la bibliothèque publique. Veuillez d'abord supprimer le partage privé ou supprimer le mot de passe.",
  active: "Actif",
  inactive: "Inactif",
  ...
  your_cad_library: "Votre Bibliothèque CAD",
  models_uploaded_to_account: "Modèles téléchargés sur votre compte",
  models_count_in_library: "Vous avez {count} modèles dans votre bibliothèque",
  no_models_in_library: "Vous n'avez pas encore de modèles dans votre bibliothèque",
  preview: "Aperçu",
  original: "Original",
  ...
  no_thumbnail_set: "Aucune miniature définie"
};
