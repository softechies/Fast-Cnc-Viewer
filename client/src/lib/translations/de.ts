...
const translations = {
  ...
  public_library_added: "Modell zur öffentlichen Bibliothek hinzugefügt",
  public_library_removed: "Modell aus öffentlicher Bibliothek entfernt",
  public_library_added_message: "Modell wurde erfolgreich zur öffentlichen CAD-Bibliothek hinzugefügt",
  public_library_removed_message: "Modell wurde erfolgreich aus der öffentlichen CAD-Bibliothek entfernt",
  public_cad_library: "Öffentliche CAD-Bibliothek",
  public_library_description: "Durchsuchen und laden Sie CAD-Modelle herunter, die von unserer Community geteilt werden. Alle Modelle sind kostenlos für Ihre Projekte.",
  search_models_tags: "Modelle und Tags suchen...",
  all_categories: "Alle Kategorien",
  showing_models: "{count} von {total} Modellen angezeigt",
  no_models_found: "Keine Modelle gefunden",
  try_different_search: "Versuchen Sie einen anderen Suchbegriff oder löschen Sie Filter",
  no_public_models_yet: "Noch keine öffentlichen Modelle verfügbar",
  failed_to_load_library: "Bibliothek konnte nicht geladen werden. Versuchen Sie es später erneut.",
  cad_library_dimensions: "Abmessungen",
  cad_library_view: "Anzeigen",
  cad_library_download: "Herunterladen",
  password_protected_public_error: "Passwort-geschütztes Modell kann nicht zur öffentlichen Bibliothek hinzugefügt werden. Bitte entfernen Sie zuerst die private Freigabe oder das Passwort.",
  active: "Aktiv",
  inactive: "Inaktiv",
  ...
  model_delete_success: "Modell wurde erfolgreich gelöscht",
