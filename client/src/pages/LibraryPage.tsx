      ...
      <div className="container mx-auto py-6">
        <div className="flex flex-col items-center justify-center p-6 bg-destructive/10 rounded-lg">
          ...
          <p className="text-center mb-4">
            {t("library.error")}: {error instanceof Error ? error.message : String(error)}
          </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="lg:col-span-1">
          <div className="bg-card rounded-lg p-4 border">
            <h2 className="text-xl font-semibold mb-4">{t("library.filters")}</h2>
        ...
        <div className="lg:col-span-3">
          {libraryModels?.length === 0 ? (
            <div className="flex flex-col items-center justify-center p-10 bg-muted/30 rounded-lg">
              ...
              <h2 className="text-xl font-semibold mb-2">{t("library.noModels")}</h2>
              <p className="text-center text-muted-foreground mb-4">
                {t("library.noModelsDescription")}
              </p>
            </div>
          ) : (
            <>
