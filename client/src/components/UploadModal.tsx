  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl">Wczytaj plik STEP</DialogTitle>
        </DialogHeader>
        ...
        {isUploading ? (
          ...
          <>
            ...
            >
              ...
              <p className="text-sm text-gray-500 text-center mb-4">
                {selectedFile 
                  ...
                  : 'Przeciągnij i upuść plik STEP lub kliknij aby wybrać'}
              </p>
              <input 
                type="file" 
                ref={fileInputRef} 
            ...
            <p className="mt-2 text-xs text-gray-500">Obsługiwane formaty: STEP (AP203, AP214)</p>
