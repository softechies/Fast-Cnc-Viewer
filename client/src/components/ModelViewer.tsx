...
export default function ModelViewer({
  ...
  useEffect(() => {
    ...
    const fetchModelInfo = async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(
            `Nie można pobrać informacji o modelu (${response.status})`
          );
        }
  ...
  console.log("modelInfo111", modelType, modelInfo, modelId, publicId);
                      ...
                      fallback={
                        <div className="p-8 text-center">
                          ...
                          <p className="text-sm text-slate-600 mb-4">
                            There was a problem loading the 3D rendering
                            component. Check if your browser supports WebGL.
                          </p>
                    ...
                    <ErrorBoundary
                      fallback={
                        <div className="p-8 text-center">
                          ...
                          <p className="text-sm text-slate-600 mb-4">
                            There was a problem loading the 2D rendering
                            component.
                          </p>
                          <Button onClick={() => window.location.reload()}>
                            Refresh page
