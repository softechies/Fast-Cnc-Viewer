...
def convert_dxf_to_svg(dxf_path, svg_path=None):
    ...
    try:
        ...
        try:
            ...
            x_min = int(min_x // grid_size)
            x_max = int(max_x // grid_size + 1)
            y_min = int(min_y // grid_size)
            y_max = int(max_y // grid_size + 1)
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 200" width="100%" height="100%">
            ...
            <text x="50" y="110" font-family="Arial" font-size="12">{str(e)}</text>
        </svg>
        '''
